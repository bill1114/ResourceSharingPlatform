@echo off
REM Stop.bat - One-click stop for ResourceSharingPlatform
...
powershell -NoProfile -Command "$RootDir = '%SCRIPT_DIR%'; Get-Content -Raw '%SCRIPT_DIR%Stop.ps1' | Invoke-Expression"
